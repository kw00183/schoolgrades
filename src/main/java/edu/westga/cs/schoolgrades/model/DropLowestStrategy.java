...
/**
 * Decorator for {@link GradeCalculationStrategy}s that drops the lowest grade
 * before applying the rest of the strategy.
 * 
 * @author lewisb
 * @version cs6241
 */
public class DropLowestStrategy implements GradeCalculationStrategy {
	 ...
	 * 
	 * @param childStrategy
	 *            the strategy from which to drop the lowest grade.
	 */
	 ...
	 * @param grades
	 *            {@inheritDoc}.
	 * @return if there are at least 2 grades, returns the calculated grade with
	 *         the lowest dropped. Otherwise, returns the calculation without
	 *         the lowest dropped.
	 */
